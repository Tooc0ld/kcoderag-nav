...
tools: Read, Grep, Glob, mcp__plugin_kcoderag-dev_kcoderag-dev__search_code, mcp__plugin_kcoderag-dev_kcoderag-dev__get_call_chain, mcp__plugin_kcoderag-dev_kcoderag-dev__context, mcp__plugin_kcoderag-dev_kcoderag-dev__list_indexes, mcp__plugin_kcoderag-dev_kcoderag-dev__cypher
---
...
- **mcp__plugin_kcoderag-dev_kcoderag-dev__search_code** — find definitions or symbols by behavior.
- **mcp__plugin_kcoderag-dev_kcoderag-dev__context** — inspect a symbol's signature and relations.
- **mcp__plugin_kcoderag-dev_kcoderag-dev__get_call_chain** — trace callers and callees across Lua and C++.
- **mcp__plugin_kcoderag-dev_kcoderag-dev__cypher** — perform custom read-only graph traversals.
- **mcp__plugin_kcoderag-dev_kcoderag-dev__list_indexes** — check graph/index health.
