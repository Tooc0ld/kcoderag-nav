...
- Official-Registry isolated `npm audit --ignore-scripts`: 0 low, 0 moderate, 0 high, 0 critical vulnerabilities.
...
- Static review found no dynamic evaluation, shell-enabled subprocess, force-push, unpublish, tag replacement, or distribution-tag rollback path.
- The two audit-discovered release provenance gaps were fixed before this subject was frozen and are covered by executable negative tests.
