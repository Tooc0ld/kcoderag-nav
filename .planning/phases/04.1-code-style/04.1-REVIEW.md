...
- **CR-01 — Fixed.** The dispatcher now loads navigation support defensively, so code-style-only installs and combined installs followed by navigation removal remain fail-open and runnable. The generated dispatcher is synchronized, and installed-launcher coverage exercises both partial-lifecycle paths.
