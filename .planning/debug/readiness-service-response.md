...
- next_action: Replace camelCase-only exact-key checks with a narrow ProtoJSON response field reader that accepts exactly one of proto-name/lowerCamel aliases and ignores bounded unknown fields.
