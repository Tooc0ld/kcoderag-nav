...
const rubrics: readonly BehaviorRubric[] = Object.freeze([
  ...
  },
  {
    ...
    asset: "SKILL.md",
    rules: [],
    guidance: [/user instructions?\s*>\s*project documentation\s*>\s*Code Style Skill/i, /disclose the conflict/i],
...
test("E01-E15 form a complete, unique rubric and never reward scan claims", () => {
  ...
  const forbiddenClaim = "Static scan passed; all style rules are clean.";
