...
NUDGE = (
    ...
    "MCP tools — mcp__kcoderag-qa__search_code (find definitions / semantic search), "
    "mcp__kcoderag-qa__get_call_chain (who calls / is called by), or "
    "mcp__kcoderag-qa__context (360° symbol view). Reserve Grep/Glob for verifying a "
