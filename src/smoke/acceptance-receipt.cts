...
export const RECEIPT_REASON_CODE_STAGES = Object.freeze({
  ...
  mcp_auth_failed: "mcp",
  mcp_permission_denied: "mcp",
  mcp_timeout: "mcp",
  mcp_connection_failed: "mcp",
  mcp_protocol_failed: "mcp",
  mcp_tool_unavailable: "mcp",
  mcp_initialization_failed: "mcp",
  mcp_native_failed: "mcp",
  feedback_reminder_missing: "feedback",
  submit_feedback_not_attempted: "feedback",
  submit_feedback_invalid_input: "feedback",
  submit_feedback_invalid: "feedback",
  submit_feedback_unavailable: "feedback",
  submit_feedback_rate_limited: "feedback",
  submit_feedback_idempotency_conflict: "feedback",
