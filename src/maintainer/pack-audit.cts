...
const REQUIRED_ASSETS = Object.freeze([
  ...
  "dist/smoke/acceptance-receipt.cjs",
  "dist/smoke/host-smoke.cjs",
  "dist/smoke/live-host-coordinator.cjs",
  ...
  "kcoderag-qa/skills/kcoderag-update/SKILL.md",
...
export const NON_PUBLISHED_COMPILED_OUTPUTS = Object.freeze([
  ...
  "dist/maintainer/acceptance-candidate.cjs",
